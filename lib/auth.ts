...
// (full access) plus E-Board (read-only: Overview/Budgets/Ledger/Analytics
// only, enforced by those pages using this check while every other admin
// page — Reimbursements, Guests, Users, Cycles, Settings — still uses the
 ...
 * shell itself and for the Overview/Budgets/Ledger/Analytics pages E-Board
 * can see; every other admin page/action should keep using requireAdmin(). */
